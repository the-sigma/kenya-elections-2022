...
UX.prototype.loadMain = function (obj) {
	...
	top.innerHTML = `<div class="race flexrow">
		...
		<h6 class="flexrow"><span class="picon odcon"><img src="imgs/azimio.png" alt="azimio"></span>AZIMIO</h6>
		<h6>50% +1 to win</h6>
		<h6 class="flexrow">UDA<span class="picon udcon"><img src="imgs/uda.png" alt="uda"></span></h6>
		</div>
		<div class="barctn">
